...
- output root: `outputs/e20-a/export`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E20 | 24687 | 81 | 81 | 69 | 32 | 43 | 26 | 23 | 0 | 64 | 56 | 56 | 56 | continuation_contact_run |
...
| E20 | 56 | 56 | 100 | 81 | 69 | 32 | 43.0 | 26 | 23.0 | 0 | 64 | 56 |  | continuation_contact_run |
...
- median ref_gap: `18.0`
- active_hand_invisible_ref_found / fallback_ref_found / fallback_ref_keep: `43` / `26` / `23`
- homography_available / geometry_pass / heatmap_pass: `64` / `56` / `56`
- no_pre_episode_reference_window_not_rescued: `0`

## success 分布

- active-hand-invisible ref_gap stats: `{'count': 56, 'mean': 51.589285714285715, 'q1': 2.0, 'median': 18.0, 'q3': 68.75, 'min': 1.0, 'max': 326.0}`
- success reference_anchor_gap stats: `{'count': 56, 'mean': 51.589285714285715, 'q1': 2.0, 'median': 18.0, 'q3': 68.75, 'min': 1.0, 'max': 326.0}`
- fallback selected hand-object IoU stats: `{'count': 26, 'mean': 0.0, 'q1': 0.0, 'median': 0.0, 'q3': 0.0, 'min': 0.0, 'max': 0.0}`
...
| no_contact_points_after_object_boundary_filter | 7 |
...
| contact_point_out_of_bounds_mu_2 | 1 |
