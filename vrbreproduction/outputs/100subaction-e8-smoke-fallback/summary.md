...
- 输出目录：`vrbreproduction/outputs/100subaction-e8-smoke-fallback`
- video_id：`P01_109`
...
- `vrbreproduction/outputs/100subaction-e8-smoke-fallback/charts/e8_success_contact_sheet_page_001.png`
