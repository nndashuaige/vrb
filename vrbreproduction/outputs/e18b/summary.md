...
- output root: `/sessions/gracious-amazing-sagan/mnt/vrbreproduction/outputs/e18b`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E18B | 24687 | 81 | 81 | 70 | 32 | 43 | 27 | 24 | 0 | 65 | 56 | 56 | 56 | continuation_contact_run |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E18 | 45 | 45 | 100 | 81 | 58 | 27 | 38.0 | 20 | 19.0 | 0 | 49 | 45 | 18.0 | continuation_contact_run |
...
| E18B | 56 | 56 | 100 | 81 | 70 | 32 | 43.0 | 27 | 24.0 | 0 | 65 | 56 |  | continuation_contact_run |

## 核心回答

- total success count: `56`
- median reference_anchor_gap: `18.0`
- median ref_gap: `18.0`
- active_hand_invisible_ref_found / fallback_ref_found / fallback_ref_keep: `43` / `27` / `24`
- homography_available / geometry_pass / heatmap_pass: `65` / `56` / `56`
- no_pre_episode_reference_window_not_rescued: `0`

## success 分布

- active-hand-invisible ref_gap stats: `{'count': 56, 'mean': 50.785714285714285, 'q1': 2.0, 'median': 18.0, 'q3': 65.0, 'min': 1.0, 'max': 326.0}`
- success reference_anchor_gap stats: `{'count': 56, 'mean': 50.785714285714285, 'q1': 2.0, 'median': 18.0, 'q3': 65.0, 'min': 1.0, 'max': 326.0}`
- fallback selected hand-object IoU stats: `{'count': 27, 'mean': 0.0, 'q1': 0.0, 'median': 0.0, 'q3': 0.0, 'min': 0.0, 'max': 0.0}`
- strict shadow reference anchor gap stats: `{'count': 32, 'mean': 66.0625, 'q1': 16.5, 'median': 49.0, 'q3': 86.5, 'min': 2.0, 'max': 274.0}`
...
| no_contact_points_after_object_boundary_filter | 6 |
| missing_hand_or_object_bbox | 5 |
| trajectory_out_of_bounds_t+0 | 3 |
| contact_point_out_of_bounds_mu_5 | 3 |
| contact_point_out_of_bounds_mu_2 | 2 |
...
| pairwise_homography_failed_f3723_to_f3722 | 1 |
...
| 52 | P01_109_52 | open drawer | 0.0 | 1.0 | 4907.0 | 0.0 | right | discard | no_contact_points_after_object_boundary_filter |  |  |  | 1.0 |
